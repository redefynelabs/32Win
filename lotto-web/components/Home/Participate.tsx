  ...
  return (
    <div className="relative w-full md:my-20">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 z-20">
        <button className="bg-primary border-10 sm:border-8 border-white rounded-full text-white font-semibold text-[18px] sm:text-[22px] md:text-[26px] px-8 sm:px-12 py-1 sm:py-2 flex items-center justify-center  hover:scale-105 transition-transform duration-300 relative">
          {/* Left sparkle */}
